...
head = Label(root,text="Password Genrator",font=("arial",40,"bold"),width=15,height=2,fg="black",bg="blue")
head.pack()

#Name lable and text field
name = Label(root,text="Name : ",font=("arial",25,"bold"),width=15,height=2,fg="black",bg="blue")
...
Email = Label(root,text="Email : ",font=("arial",25,"bold"),width=15,height=2,fg="black",bg="blue")
...
Mob = Label(root,text="Mobile no: ",font=("arial",25,"bold"),width=15,height=2,fg="black",bg="blue")
Mob.place(x=5,y=240)
...
len = Label(root,text="Set length : ",font=("arial",25,"bold"),width=15,height=2,fg="black",bg="blue")
len.place(x=5,y=310)
...
generate = Button(root,text="Generate",bg="darkred",fg="black",font=("arial",20,"bold"),height=1,width=19,command=genarate)
generate.place(x=370,y=325)

#label for showing password
password = Label(root,text="password",font=("arial",20,"bold"),width=46,height=2,fg="black",bg="lightblue")
password.place(x=5,y=400)

#button for regenerating password
re_gen = Button(root,text="Re - Generate",bg="Green",fg="black",font=("arial",20,"bold"),height=1,width=14,command=genarate)
...
copy = Button(root,text="Copy",bg="red",fg="black",font=("arial",20,"bold"),height=1,
...
clear = Button(root,text="Clear",bg="yellow",fg="black",font=("arial",20,"bold"),height=1,width=14,command=clear)
